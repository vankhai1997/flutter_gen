...
Default configuration can be found [here](https://github.com/rinlv/flutter_gen/blob/easy_localization/packages/core/lib/settings/config_default.dart). 
...
flutter_gen:
  ...
  localization:
    sheet_id: '1v2Y3e0Uvn0JTwHvsduNT70u7Fy9TG43DIcZYJxPu1ZA'
...
[FlutterGen] supports generating [easy_localization](https://github.com/aissat/easy_localization) from [CSV Google Sheet](https://docs.google.com/spreadsheets/d/1v2Y3e0Uvn0JTwHvsduNT70u7Fy9TG43DIcZYJxPu1ZA/edit?usp=sharing).

Make sure that your sheet is shared :

<img src="./art/share.png" />

Extract from the link the `sheet_id` value : `https://docs.google.com/spreadsheets/d/<sheet_id>/edit?usp=sharing`
_Ignore duplicated._
